...
class CNN3D(nn.Module):
    def __init__(self, in_channels=3,sample_size=128, sample_duration=16, drop_p=0.0, hidden1=512, hidden2=256, num_classes=100):
        ...
        self.conv1 = nn.Conv3d(in_channels=self.in_channels, out_channels=self.ch1, kernel_size=self.k1,
